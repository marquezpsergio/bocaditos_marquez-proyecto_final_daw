  ...
  <div class="container" id="container_recDatos">
    <div class="row">
      <div class="col-12 col-md-8 offset-md-2 text-white my-3 text-center" id="recuperar_Datos_col">
        <img src="../img/errores/policia.png" width="50%" class="mt-2 mb-4">
        <p class="font-weight-bold" id="primerParrafoRec">Alto amigo! No tienes permiso para acceder a esta página</p>
        <p class="font-weight-light" id="segundoParrafoRec">Tranquilo, estás perdonado. Pulsa en el siguiente enlace para volver a la página principal.</p>
