  ...
  <div class="container" id="container_recDatos">
    <div class="row">
      <div class="col-12 col-md-8 offset-md-2 text-white my-3 text-center" id="recuperar_Datos_col">
        <img src="../img/errores/oops.png" width="40%" class="mb-3">
        <p class="font-weight-bold" id="primerParrafoRec">Parece ser que te has equivocado de página amigo!</p>
        <p class="font-weight-light" id="segundoParrafoRec">No te preocupes, pulsa en el siguiente enlace para volver a la página principal.</p>
